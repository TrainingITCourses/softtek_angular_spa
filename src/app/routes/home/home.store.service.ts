...
import { computed, effect, inject, Injectable, ResourceStatus, Signal, WritableSignal } from '@angular/core';
...
export class HomeStoreService {
  ...
  private ipApiResource: HttpResourceRef<IpApi|undefined> = httpResource<IpApi>(this.IP_API_URL);
